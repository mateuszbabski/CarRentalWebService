        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyIdentificationNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Reservations_RentalCompanies_RentalCompanyId",
                        column: x => x.RentalCompanyId,
                        principalTable: "RentalCompanies",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VehicleId = table.Column<int>(type: "int", nullable: true),
                    FullPriceForRenting = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Invoices_RentalCompanies_RentalCompanyId",
                        column: x => x.RentalCompanyId,
                        principalTable: "RentalCompanies",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Invoices_RentalCompanyId",
                table: "Invoices",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_RentalCompanyId",
                table: "Reservations",
                column: "RentalCompanyId");
